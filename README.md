...
- Откройте issue с описанием задачи/баг-репорта.
- Сделайте fork и pull-request с кратким пояснением изменений.

Контакты
--------

Для вопросов — откройте issue в репозитории или напишите автору проекта.
